...
for pred_len in 96 192 336 720; do
    case $pred_len in
        96)  d_model=24;  layers=3; dropout=0.1; epochs=30; patience=8;  batch=256; lr=0.0008;    lradj=constant ;;
        192) d_model=32;  layers=3; dropout=0.1; epochs=30; patience=8;  batch=128; lr=0.001419;  lradj=constant ;;
        336) d_model=24;  layers=3; dropout=0.1; epochs=30; patience=8;  batch=256; lr=0.00072;   lradj=constant ;;
        720) d_model=32;  layers=3; dropout=0.0; epochs=70; patience=14; batch=256; lr=0.00015;   lradj=constant ;;
    esac
