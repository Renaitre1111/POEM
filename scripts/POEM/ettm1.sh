...
for pred_len in 96 192 336 720; do
    case $pred_len in
        96)  d_model=32; layers=2; dropout=0.1; epochs=30; patience=8; batch=256; lr=0.001;   lradj=constant ;;
        192) d_model=32; layers=1; dropout=0.1; epochs=30; patience=8; batch=256; lr=0.00095; lradj=constant ;;
        336) d_model=24; layers=1; dropout=0.1; epochs=30; patience=8; batch=256; lr=0.001;   lradj=type3 ;;
        720) d_model=24; layers=1; dropout=0.1; epochs=30; patience=8; batch=512; lr=0.001;   lradj=constant ;;
    esac
