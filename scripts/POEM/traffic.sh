...
for pred_len in 96 192 336 720; do
    case $pred_len in
        96)  d_model=64;  layers=2; dropout=0.1; epochs=30; patience=8; batch=16; lr=0.001;  lradj=constant ;;
        192) d_model=128; layers=1; dropout=0.1; epochs=30; patience=8; batch=16; lr=0.0012; lradj=3 ;;
        336) d_model=128; layers=1; dropout=0.1; epochs=30; patience=8; batch=16; lr=0.0012; lradj=3 ;;
        720) d_model=192; layers=1; dropout=0.3; epochs=30; patience=8; batch=16; lr=0.0008; lradj=3 ;;
    esac

    echo "=== POEM traffic pred_len=${pred_len} ==="
